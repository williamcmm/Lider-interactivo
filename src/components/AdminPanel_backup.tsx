...
export function AdminPanel({}: AdminPanelProps) {
  ...
  const mockSeminars: Seminar[] = [
          ...
          fragments: [
            {
              ...
              studyAids: '<p>Ayudas de estudio</p>',
              isCollapsed: false
            }
          ]
        }
    ...
    {
      id: 'sem-2',
      title: 'Discipulado Efectivo',
      description: 'Estrategias para hacer discípulos',
      lessons: [],
      order: 2,
      audioFiles: []
    }
  ...
  const mockSeries: Series[] = [
    {
      id: 'ser-1',
      title: 'Estudios de Carácter',
      description: 'Serie enfocada en el desarrollo del carácter cristiano',
      lessons: [],
      order: 1,
      audioFiles: []
    }
  ...
  // Inicializar datos mock una sola vez
  if (seminars.length === 0 && series.length === 0) {
  ...
  const handleCreateContainer = () => {
    ...
    setCreationForm({
      ...
      lessonsCount: 10,
      lessons: Array.from({ length: 10 }, (_, i) => ({ title: '', order: i + 1 })),
      audioFiles: [] as AudioFile[] // AudioFiles para el seminario
    });
  };
