...
import { FiPlus, FiEdit, FiTrash2, FiBook, FiList, FiSave, FiArrowLeft, FiX, FiChevronDown, FiChevronUp } from 'react-icons/fi';
import { Seminar, Series, StudyContainer, Fragment, AudioFile } from '@/types';
import { LocalStorage } from '@/lib/storage';

interface AdminPanelProps { [key: string]: unknown }
